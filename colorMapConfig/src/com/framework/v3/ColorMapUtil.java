...
public class ColorMapUtil {
     ...
     * @throws Exception
     */
    public synchronized static JSONObject colorMap_IDW(GridDataConfig config) throws Exception{
        ...
        if(config.getGridData()!=null){
            ...
            interSet.setRadius(10);
            interSet.setMissingValue(-999999);
            interSet.setInterpolationMethod(InterpolationMethods.Cressman);//临近点插值法
